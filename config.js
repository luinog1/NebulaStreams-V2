...
export const config = Object.freeze({
  ...
  MAXIMIZE_PROVIDER_COVERAGE: toBoolean(process.env.MAXIMIZE_PROVIDER_COVERAGE, false),
  ...
  SCRAPLING_SERVICE_AUTOSTART: toBoolean(process.env.SCRAPLING_SERVICE_AUTOSTART, false),
  ...
  STREMIO_FAST_MAX_WAIT_MS: toBoundedInteger(process.env.STREMIO_FAST_MAX_WAIT_MS, 9000, 1000, 120000),
